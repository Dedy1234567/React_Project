...
export default function AddProduct() {
  ...
  // Handler functions untuk toggle sections
  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] max-w-7xl mx-auto pt-5 px-4 lg:px-0 flex flex-col lg:flex-row gap-4 lg:gap-6">
      ...
      <aside className="w-full lg:w-72 bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 flex-shrink-0 mb-4 lg:mb-0 flex flex-col overflow-hidden">
        <nav className="flex-1 p-4 space-y-2 pt-6">
          <button
            ...
            className="w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400"
          >
      ...
      <main className="flex-1 space-y-6 min-w-0">
        ...
        {/* Form Tambah/Edit Produk - Hanya tampil jika tidak ada section lain yang aktif */}
        {!showSalesHistory &&
          !showShippingManagement &&
          !showCourierManagement && (
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="relative">
                <ShoppingBag className="absolute left-3 top-4 w-5 h-5 text-gray-400 dark:text-gray-500" />
                <input
                  type="text"
                  name="name"
